...
\section*{II. Abkürzungsverzeichnis}
\addcontentsline{toc}{section}{Abkürzungsverzeichnis}
\begin{tabbing}
    \hspace{3cm} \= \kill
    BS \> Black-Scholes-Modell \\
    CF \> Charakteristische Funktion (Characteristic Function) \\
    COS \> Fourier-Cosinus-Methode \\
...
Die Bewertung derivativer Finanzinstrumente erfordert in der Praxis leistungsfähige numerische Verfahren. Während das klassische Modell von Black und Scholes \citep{hullOptionsFuturesOther2022} für europäische Standardoptionen eine geschlossene Lösung bietet, erfordern realitätsnähere Modelle -- etwa mit stochastischer Volatilität oder Sprungprozessen -- oft numerische Näherungsverfahren.
...
\begin{enumerate}
    ...
    \item \textbf{Modellvergleich:} Anwendung der COS-Methode auf ein alternatives Modell (z.\,B.\ Merton Jump-Diffusion) und Überprüfung der Korrektheit anhand bereitgestellter Referenzalgorithmen.
\end{enumerate}
